export interface JuiceProduct {
  ...
  const mockProducts: JuiceProduct[] = [
    ...
    { id: 5, name: 'Jus Alpukat', price: 20000, imageSrc: '/images/jus alpukat.png', bgColor: '#DCEDC8', description: 'Rich avocado and almond milk.', category: 'Juice', tags: ['best_seller'] },
